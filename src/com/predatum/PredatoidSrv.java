...
public class PredatoidSrv extends Service {
    ...
    private void notify(int icon, String s) {
        ...
        notty.setLatestEventInfo(getApplicationContext(), "Predatoid", s,
    ...
    private class Launcher {
        ...
        void launch(String path) {
            startActivity((new Intent()).setAction(PredatoidSrv.ACTION_VIEW).setData(Uri.fromFile(new File(path))));
        }
    }
